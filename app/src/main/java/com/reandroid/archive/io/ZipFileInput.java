...
import io.github.abdurazaaqmohammed.ApkExtractor.LegacyUtils;
...
public class ZipFileInput extends ZipInput {
    ...
    public FileChannel getFileChannel() throws IOException {
        ...
        synchronized (this){
            ...
            fileChannel = LegacyUtils.supportsFileChannel ? FileChannel.open(this.file.toPath(), StandardOpenOption.READ) : new RandomAccessFile(file, "r").getChannel();
